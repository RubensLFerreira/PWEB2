  ...
  btn.addEventListener("click", () => {
    ...
    if (!btn.id.match("erase")) {
      ...
      if (btn.classList.contains("num_btn")) {
        let result1 = Function("return " + realTimeScreenValue.join(""))();
        answerScreen.innerHTML = result1;
    ...
    if (btn.id.match("erase")) {
      ...
      currentInput.innerHTML = realTimeScreenValue.join("");
      let result2 = Function("return " + realTimeScreenValue.join(""))();
      answerScreen.innerHTML = result2;
      // answerScreen.innerHTML = eval(realTimeScreenValue.join(""));
    }
    ...
    let result3 = Function("return " + realTimeScreenValue.join(""))();
